 ...
 *
 */
contract ERC721FUpgradeableInternal is IERC721Upgradeable {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            ERC721FStorage.layout()._balances[to] += 1;
        }

        ERC721FStorage.layout()._owners[tokenId] = to;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // Clear approvals
        delete ERC721FStorage.layout()._tokenApprovals[tokenId];

        unchecked {
            // Cannot overflow, as that would require more tokens to be burned/transferred
            // out than the owner initially received through minting and transferring in.
            ERC721FStorage.layout()._balances[owner] -= 1;
        }
        delete ERC721FStorage.layout()._owners[tokenId];
    ...
    function _transfer(
        ...
        unchecked {
            ...
            ERC721FStorage.layout()._balances[from] -= 1;
            ERC721FStorage.layout()._balances[to] += 1;
        }
        ERC721FStorage.layout()._owners[tokenId] = to;
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ERC721FStorage.layout()._tokenApprovals[tokenId] = to;
